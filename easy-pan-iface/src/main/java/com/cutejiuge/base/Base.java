...
public class Base implements org.apache.thrift.TBase<Base, Base._Fields>, java.io.Serializable, Cloneable, Comparable<Base> {
  ...
  public @org.apache.thrift.annotation.Nullable String logID; // required
  public @org.apache.thrift.annotation.Nullable String caller; // required
  public @org.apache.thrift.annotation.Nullable String addr; // required
  public @org.apache.thrift.annotation.Nullable String client; // required
  ...
  public Base setLogID(@org.apache.thrift.annotation.Nullable String logID) {
    this.logID = logID;
    return this;
  }
  ...
  public Base setCaller(@org.apache.thrift.annotation.Nullable String caller) {
    this.caller = caller;
    return this;
  }
  ...
  public Base setAddr(@org.apache.thrift.annotation.Nullable String addr) {
    this.addr = addr;
    return this;
  }
  ...
  public Base setClient(@org.apache.thrift.annotation.Nullable String client) {
    this.client = client;
    return this;
  }
  ...
  public Base setExtra(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> extra) {
    this.extra = extra;
    return this;
  }
  ...
  public int compareTo(Base other) {
    ...
    lastComparison = Boolean.compare(isSetCaller(), other.isSetCaller());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCaller()) {
    ...
    lastComparison = Boolean.compare(isSetClient(), other.isSetClient());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClient()) {
    ...
    lastComparison = Boolean.compare(isSetTrafficEnv(), other.isSetTrafficEnv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTrafficEnv()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra = new java.util.HashMap<String, String>(2*_map0.size);
      ...
      if (struct.extra != null) {
        if (struct.isSetExtra()) {
          oprot.writeFieldBegin(EXTRA_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter4 : struct.extra.entrySet())
            {
      ...
      if (struct.isSetExtra()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter5 : struct.extra.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.extra = new java.util.HashMap<String, String>(2*_map6.size);
