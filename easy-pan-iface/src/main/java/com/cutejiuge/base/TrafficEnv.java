...
public class TrafficEnv implements org.apache.thrift.TBase<TrafficEnv, TrafficEnv._Fields>, java.io.Serializable, Cloneable, Comparable<TrafficEnv> {
  ...
  public @org.apache.thrift.annotation.Nullable String env; // required
  ...
  public TrafficEnv setEnv(@org.apache.thrift.annotation.Nullable String env) {
    this.env = env;
    return this;
  }
  ...
  public int compareTo(TrafficEnv other) {
    ...
    lastComparison = Boolean.compare(isSetEnv(), other.isSetEnv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnv()) {
