...
public class UserLoginData implements org.apache.thrift.TBase<UserLoginData, UserLoginData._Fields>, java.io.Serializable, Cloneable, Comparable<UserLoginData> {
  ...
  private static final org.apache.thrift.protocol.TField JWT_TOKEN_FIELD_DESC = new org.apache.thrift.protocol.TField("jwtToken", org.apache.thrift.protocol.TType.STRING, (short)5);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String jwtToken; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.USED_SPACE, new org.apache.thrift.meta_data.FieldMetaData("usedSpace", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.JWT_TOKEN, new org.apache.thrift.meta_data.FieldMetaData("jwtToken", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public UserLoginData setJwtToken(@org.apache.thrift.annotation.Nullable java.lang.String jwtToken) {
    this.jwtToken = jwtToken;
    return this;
  }
  ...
  /** Returns true if field jwtToken is set (has been assigned a value) and false otherwise */
  public boolean isSetJwtToken() {
    return this.jwtToken != null;
  }

  public void setJwtTokenIsSet(boolean value) {
    if (!value) {
      this.jwtToken = null;
    }
  }
  ...
  public boolean equals(UserLoginData that) {
    ...
    boolean this_present_jwtToken = true && this.isSetJwtToken();
    boolean that_present_jwtToken = true && that.isSetJwtToken();
    if (this_present_jwtToken || that_present_jwtToken) {
      if (!(this_present_jwtToken && that_present_jwtToken))
        return false;
      if (!this.jwtToken.equals(that.jwtToken))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetJwtToken()) ? 131071 : 524287);
    if (isSetJwtToken())
      hashCode = hashCode * 8191 + jwtToken.hashCode();
  ...
  public int compareTo(UserLoginData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetJwtToken(), other.isSetJwtToken());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJwtToken()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.jwtToken, other.jwtToken);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class UserLoginDataStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserLoginData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserLoginData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // JWT_TOKEN
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.jwtToken = iprot.readString();
              struct.setJwtTokenIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserLoginData struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.jwtToken != null) {
        oprot.writeFieldBegin(JWT_TOKEN_FIELD_DESC);
        oprot.writeString(struct.jwtToken);
        oprot.writeFieldEnd();
      }
