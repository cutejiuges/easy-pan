...
public class GetVerifyCodeRequest implements org.apache.thrift.TBase<GetVerifyCodeRequest, GetVerifyCodeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetVerifyCodeRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetVerifyCodeRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GetVerifyCodeRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GetVerifyCodeRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetVerifyCodeRequest.class, metaDataMap);
  }
   ...
   */
  public GetVerifyCodeRequest(GetVerifyCodeRequest other) {
  ...
  @Override
  public GetVerifyCodeRequest deepCopy() {
  ...
  public GetVerifyCodeRequest setVerifyType(byte verifyType) {
    this.verifyType = verifyType;
    setVerifyTypeIsSet(true);
    return this;
  }
  ...
  public GetVerifyCodeRequest setBase(@org.apache.thrift.annotation.Nullable com.cutejiuge.base.Base base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof GetVerifyCodeRequest)
      return this.equals((GetVerifyCodeRequest)that);
    return false;
  }

  public boolean equals(GetVerifyCodeRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GetVerifyCodeRequest other) {
    ...
    lastComparison = Boolean.compare(isSetVerifyType(), other.isSetVerifyType());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetVerifyCodeRequest(");
    boolean first = true;
  ...
  private static class GetVerifyCodeRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public GetVerifyCodeRequestStandardScheme getScheme() {
      return new GetVerifyCodeRequestStandardScheme();
    }
  }

  private static class GetVerifyCodeRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetVerifyCodeRequest> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, GetVerifyCodeRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetVerifyCodeRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetVerifyCodeRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public GetVerifyCodeRequestTupleScheme getScheme() {
      return new GetVerifyCodeRequestTupleScheme();
    }
  }

  private static class GetVerifyCodeRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetVerifyCodeRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetVerifyCodeRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetVerifyCodeRequest struct) throws org.apache.thrift.TException {
